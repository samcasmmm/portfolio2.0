      ...
      <div className='mx-auto max-w-6xl'>
        ...
        <div className='mb-12 space-y-4'>
          ...
          <motion.div variants={fadeIn('up', 'tween', 0.15, 0.7)} className='space-y-3'>
            <h2 id='works-heading' className='font-mono text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tight text-white'>
              Featured Systems &{' '}
              <span className='wave-gradient-text font-black'>Projects.</span>
            </h2>
            <p className='max-w-3xl text-sm sm:text-base font-light leading-relaxed text-secondary'>
              Production SaaS engines, fluid 60fps mobile applications, high-throughput microservices, and automated messaging infrastructure engineered for real-world reliability.
            </p>
          </motion.div>
          ...
          >
            ...
            <span className='rounded-md border border-white/5 bg-white/[0.03] px-2.5 py-1 font-mono text-[11px] font-medium text-white/70'>
